            ...
            if(self.state_move == 'move_ggcnn'):
                ...
                if (abs(self.P_off) > self.dist_ggcnn):
                    ...
                    # Check for major deviations
                        ...
                        if ((abs(self.servo_goal.stamped_pose.pose.position.x) - abs(self.grab_xP)) > self.ggcnn_dev_pos):
                            print('MOVE - Major deviation at X_P: ', (abs(self.servo_goal.stamped_pose.pose.position.x) - abs(self.grab_xP)))
                            self._set_goal()
                        elif ((abs(self.servo_goal.stamped_pose.pose.position.y) - abs(self.grab_yP)) > self.ggcnn_dev_pos):
                            print('MOVE - Major deviation at Y_P: ', (abs(self.servo_goal.stamped_pose.pose.position.y) - abs(self.grab_yP)))
                            self._set_goal()
                        elif ((abs(self.servo_goal.stamped_pose.pose.position.z) - abs(self.grab_zP)) > self.ggcnn_dev_pos):
                            print('MOVE - Major deviation at Z_P: ', (abs(self.servo_goal.stamped_pose.pose.position.z) - abs(self.grab_zP)))
                            self._set_goal()
                        elif ((abs(self.servo_goal.stamped_pose.pose.orientation.x) - abs(self.grab_xO)) > self.ggcnn_dev_orient):
                            print('MOVE - Major deviation at X_O: ', (abs(self.servo_goal.stamped_pose.pose.orientation.x) - abs(self.grab_xO)))
                            self._set_goal()
                        elif ((abs(self.servo_goal.stamped_pose.pose.orientation.y) - abs(self.grab_yO)) > self.ggcnn_dev_orient):
                            print('MOVE - Major deviation at Y_O: ', (abs(self.servo_goal.stamped_pose.pose.orientation.y) - abs(self.grab_yO)))
                            self._set_goal()
                        elif ((abs(self.servo_goal.stamped_pose.pose.orientation.z) - abs(self.grab_zO)) > self.ggcnn_dev_orient):
                            print('MOVE - Major deviation at Z_O: ', (abs(self.servo_goal.stamped_pose.pose.orientation.z) - abs(self.grab_zO)))
                            self._set_goal()
                        elif ((abs(self.servo_goal.stamped_pose.pose.orientation.w) - abs(self.grab_wO)) > self.ggcnn_dev_orient):
                            print('MOVE - Major deviation at W_O: ', (abs(self.servo_goal.stamped_pose.pose.orientation.w) - abs(self.grab_wO)))
                            self._set_goal()
